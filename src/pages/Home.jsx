...
function Home() {
  ...
  const handleSubmit = () =>{
    if (mots.length===1 && mots[0]==="mots clés")  setErr(true);
    else
      navigate('/annonces');
  ...
  return (
    <div className={`flex flex-col items-center justify-around py-20 min-h-[calc(100vh-64px)]  md:min-h-[calc(100vh-80px)] mt-16 md:mt-20 home ${isToggle&&"pt-28"}`}>
      ...
      <div className="relative w-96 border-2 border-solid border-[#707070] flex justify-center gap-4 h-fit bg-white rounded-[56px]">
        {/* <div className="relative border-r-2  grow p-2 flex justify-center items-center border-[#707070]">
          ...
          <label htmlFor="titre-modal" className="bg-[#E7E6E3] text-left select-none text-[#0C5788] font-semibold text-sm md:text-xl px-3 w-full rounded-[56px] py-2 cursor-text" >{title.trim()}</label>
        </div>
        <div className=" relative  flex justify-center items-center grow py-2 ">
          ...
          <label htmlFor="desc-modal" className="bg-[#E7E6E3] text-left select-none text-[#0C5788] font-semibold text-sm md:text-xl px-3 w-full rounded-[56px] py-2 cursor-text" >
            {description.trim()}
            </label>
        </div> */}
      ...
      <label htmlFor="titre-modal" className="modal cursor-pointer">
        <label className="modal-box h-2/5 flex flex-col justify-between items-center relative bg-[#E9E9E9] border-2 border-[#888282] rounded-xl" htmlFor="">
          ...
          }} className="bg-[#E9E9E9] text-[#7C8287] h-full w-full p-3 resize-none focus:ring-0 border-none outline-none "   placeholder="Titre de l'annonce" ></textarea>
      ...
      <label htmlFor="desc-modal" className="modal cursor-pointer">
        <label className="modal-box h-2/5 flex flex-col justify-between items-center relative bg-[#E9E9E9] border-2 border-[#888282] rounded-xl" htmlFor="">
          <textarea name="description" id="desc"  onChange={(e)=>{
            ...
            } className="bg-[#E9E9E9] text-[#7C8287] h-full w-full p-3 resize-none border-none outline-none focus:ring-0"   placeholder="Description de l'annonce" ></textarea>
          <div className=" modal-action">
