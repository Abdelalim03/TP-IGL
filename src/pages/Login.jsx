...
function Login() {
  ...
  return (
    <div className='flex justify-center mt-16 md:mt-20 flex-col gap-10 items-center h-[calc(100vh-80px)]'>
    <div className='flex flex-col shadow-xl rounded-3xl h-2/5 w-3/5 md:w-2/5'>
        ...
        <div className='relative text-[#7A7474] h-3/4 flex flex-col justify-center mb-5 gap-5 items-center'>
            <p className='font-semibold w-[80%] text-sm md:text-base text-center'>Connectez-vous avec votre compte <span className='underline'>Google</span> </p>
