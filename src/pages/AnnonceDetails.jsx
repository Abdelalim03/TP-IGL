      ...
      <div className="pl-[5%] pr-[5%] pt-[2%] pb-[2%] ">
              ...
              <div className=" pt-[2%]  w-full flex flex-col items-center lg:items-start lg:flex-row gap-7 justify-between ">
                   ...
                   <div className="w-[45%] flex flex-col justify-center items-center ">
                        ...
                        {annonce.pics.length &&<div className='w-[80%] mt-3 flex justify-center'>
                             {
                   ...
                   <div className="w-[45%] bg-[#E9E9E9]   border-[1px] rounded-xl p-8 border-[#888282] ">
                   <div className="flex justify-between items-center   ">
                        ...
                        <div className="mt-[5%] text-[#514F4D] lg:text-xl md:text-lg sm:text-md text-xs">{annonce.description}</div>
